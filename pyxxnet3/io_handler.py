...
class TcpIoHandlerInterface(object):
    ...
    def get_opt_code(self):
        return 0

    def set_opt_code(self,optcode):
        raise NotImplementedError()
...
class TcpIoHandler(TcpIoHandlerInterface):
    ...
    __slots__ = (
        ...
        'send_buffer', 'send_buffer_lock', 'send_bytes', 'recv_bytes', 'last_recv_time', 'which','opt_code')
